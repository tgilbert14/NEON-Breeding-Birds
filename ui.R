        ...
        layout_columns(col_widths = c(7, 5),
          card(full_screen = TRUE,
            card_head("graph-up", "Species accumulation (by points counted)",
              info_pop("Accumulation", p("As more of the site's points are counted, how many species turn up (incidence pooled across all monitored years). A flattening curve means most species have been found."))),
